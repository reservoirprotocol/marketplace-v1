...
| NEXT_PUBLIC_DESKTOP_NAVBAR_LOGO   | `false`  | `String` OR [URL href](https://developer.mozilla.org/en-US/docs/Web/API/URL/href) | `N/A`                                                                                     | Loot Marketplace                                        | The logo shown on the left side of the top navbar for desktop breakpoints. It can be a relative path or a URL href                                                                             |
| NEXT_PUBLIC_NAVBAR_LOGO           | `false`  | `String` OR [URL href](https://developer.mozilla.org/en-US/docs/Web/API/URL/href) | `N/A`                                                                                     | /logo.png                                               | The logo shown on the left side of the top navigation bar for mobile breakpoints. It can be a relative path or a URL href.                                                                     |
