      ...
      {attributes?.map((attribute) => (
        ...
        >
          <Accordion.Header className="flex w-full justify-between border-gray-300 dark:border-neutral-600">
            <Accordion.Trigger className="rounded-full pill border-primary-400 flex w-full items-center justify-between p-3 px-5 transition hover:bg-[#dde2f6] dark:hover:bg-primary-900">
              {attribute.key}
