...
const HeroStats: FC<{ stats: Props }> = ({ stats }) => {
  ...
  return (
    <div className="grid min-w-full grid-cols-2 pill !border-primary-800/[.1] items-center bg-primary-100 text-primary-800 gap-[1px] overflow-hidden rounded-[25px] dark:border-[#525252] dark:bg-[#525252] md:m-0 md:min-w-[547px] md:grid-cols-4 md:gap-2 dark:md:bg-black">
      <Stat name="items">
