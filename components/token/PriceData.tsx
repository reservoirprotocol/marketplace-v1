        ...
        <div className="mt-6 grid grid-cols-1 gap-3 md:grid-cols-2">
          {account.isDisconnected ? (
            ...
            <>
              ...
              {!isOwner && (
                <BuyNow
                  buttonClassName="btn-primary-fill rounded-full border-2 border-primary-500 hover:border-primary-500/50 bg-primary-550 hover:!bg-primary-550 focus:!bg-primary-550 text-primary-500 col-span-1"
                  data={{
                    details: details,
                  }}
                  signer={signer}
